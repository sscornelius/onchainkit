...
describe('getName', () => {
  ...
  it('should return baseSepolia username', async () => {
    const walletAddress = '0x1234567890123456789012345678901234567890' as Address;
    const expectedEnsName = 'leo.basetest.eth';
  ...
  it('should return base username', async () => {
    const walletAddress = '0x1234567890123456789012345678901234567890' as Address;
    const expectedEnsName = 'leo.base.eth';
    mockReadContract.mockResolvedValue(expectedEnsName);
